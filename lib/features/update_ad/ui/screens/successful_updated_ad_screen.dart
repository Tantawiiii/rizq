...
class SuccessfulUpdateAdScreen extends StatelessWidget {
  const SuccessfulUpdateAdScreen({super.key});
              ...
              Expanded(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Text(
                      LocaleKeys.createAd_adUpdatedSuccessfully.tr(context: context),
                      style: AppTextStyles.cairoTextStyle(
                        size: 18,
                        fontWeight: FontWeight.w600,
                        color: AppColors.primaryColor,
