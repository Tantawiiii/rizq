...
import 'package:rizq/features/auth/register/ui/seller/seller_commercial_info.dart';
                            ...
                            CustomDropdownButton(
                              ...
                              onChanged: (s) {
                                if (s != null && s.isNotEmpty) {
                                  ...
                                  cubit.governorateId = cubit.governorates.where((gov)=>gov.name.getNameInCurrentLocale(context) == s).first.id;
                                }
                              },
                        ...
                        PrimaryButton(
                          ...
                          onPressed: (){
                            if(formKey.currentState!.validate()){
                              ...
                              // get categories before navigating to second screen
                              RouteManager.navigateTransitionaly(BlocProvider.value(
                                  value: cubit..getCategories(),
                                  child: RegisterSellerCommercialInfoScreen()));
                            }
