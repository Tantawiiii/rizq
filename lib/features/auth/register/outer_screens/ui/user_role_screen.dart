...
import 'package:rizq/features/auth/register/outer_screens/ui/register_method_screen.dart';
              ...
              child: Column(
                ...
                children: [
                  ...
                  SelectableContainer(
                      ...
                      isSelected: cubit.userRole == UserRole.personal,
                      onPressed: (){
                        cubit.changeUserRole(UserRole.personal);
                      }
                  ),
                  20.vGap,
                  SelectableContainer(
