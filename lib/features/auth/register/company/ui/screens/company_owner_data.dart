...
import 'package:rizq/features/auth/register/company/ui/screens/company_data.dart';
...
class RegisterCompanyOwnerData extends StatelessWidget {
  const RegisterCompanyOwnerData({super.key});
                ...
                child: Column(
                  children: [
                    ...
                    PrimaryButton(
                      ...
                      onPressed: (){
                        RouteManager.navigateTo(RegisterCompanyDataScreen());
                      },
                    ),
                    25.vGap,
